...
import AnsarLogo from './logo/Ansar.svg';
import AyandehLogo from './logo/Ayandeh.svg';
import HekmatLogo from './logo/Bank-Hekmat.svg';
import MarkaziLogo from './logo/Bank-Markazi.svg';
import DayLogo from './logo/Day.svg';
import EghtesadNovinLogo from './logo/Eghtesad.svg';
import GardeshgariLogo from './logo/Gardeshgari.svg';
import GhavaminLogo from './logo/Ghavamin.svg';
...
import KosarLogo from './logo/Kosar.svg';
import MaskanLogo from './logo/Maskan.svg';
import MehrLogo from './logo/Mehr.svg';
import MehrEghtesadLogo from './logo/Mehr-Eghtesad.svg';
...
import ToseeLogo from './logo/Tosee.svg';
import ToseeTaavonLogo from './logo/Tosee-Taavon.svg';
import ToseeSaderatLogo from './logo/Tosee-Saderat.svg';
...
export const allBankInfo:BankInfo = [
    ...
    { title: { fa: 'بانک سپه', en: 'Sepah Bank' }, prefix: ['589210', '636949', '505801'], logo: SepahLogo, color: '#E8651D', primary: '#CE6C36' },
    ...
    { title: { fa: 'موسسه اعتباری توسعه', en: "Tose'e Bank" }, prefix: ['628157'], logo: ToseeLogo, color: '#891F1A', primary: '#854340' },
    ...
    { title: { fa: 'بانک انصار', en: 'Ansar Bank' }, prefix: ['627381'], logo: AnsarLogo, color: '#C6393B', primary: '#B44B4C' },
    { title: { fa: 'بانک آینده', en: 'Ayande Bank' }, prefix: ['636214'], logo: AyandehLogo, color: '#522D1D', primary: '#634C42' },
    { title: { fa: 'بانک حکمت ایرانیان', en: 'Hekmat Iranian Bank' }, prefix: ['636949'], logo: HekmatLogo, color: '#015BAA', primary: '#4D88BC' },
    ...
    { title: { fa: 'بانک قوامین', en: 'Ghavamin Bank' }, prefix: ['639599'], logo: GhavaminLogo, color: '#0A5F3E', primary: '#366B57' },
    ...
    { title: { fa: 'موسسه اعتباری کوثر', en: 'Kosar Bank' }, prefix: ['505801'], logo: KosarLogo, color: '#940509', primary: '#8C3335' },
    ...
    { title: { fa: 'بانک مهر اقتصاد', en: 'Mehr Eghtesad Bank' }, prefix: ['639370'], logo: MehrEghtesadLogo, color: '#00A652', primary: '#309863' },
